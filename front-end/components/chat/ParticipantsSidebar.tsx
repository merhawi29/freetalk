...
export default function ParticipantsSidebar({
    ...
    return (
        <div className="w-72 bg-white dark:bg-slate-900 border-l border-slate-200 dark:border-slate-800 flex flex-col h-full transition-colors duration-300">
            {/* Header & Search */}
            <div className="p-4 border-b border-slate-200 dark:border-slate-800 bg-gray-50/50 dark:bg-slate-900/50 sticky top-0 z-10 backdrop-blur-md">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-6 scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-slate-800">
                {participants.length <= 1 ? (
                    ...
                    <>
                        ...
                        {inCall.length > 0 && (
                            <div>
                                <h3 className="text-[10px] font-bold uppercase tracking-wider text-amber-600 dark:text-amber-500 mb-3 flex items-center gap-1.5">
            ...
            <div className="p-3 border-t border-slate-200 dark:border-slate-800 bg-gray-50/50 dark:bg-slate-900/50 text-[10px] text-slate-400 text-center flex flex-col gap-1">
                <p>Privacy is our priority.</p>
                <p className="opacity-60 font-mono text-[9px]">Scoped to room context</p>
            </div>
        </div>
    );
}
