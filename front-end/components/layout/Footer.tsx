...
export default function Footer() {
    return (
        <footer className="bg-white dark:bg-slate-950 border-t border-slate-200 dark:border-slate-900 py-12 mt-auto text-slate-600 dark:text-slate-400 transition-colors duration-300">
            <div className="container mx-auto px-4">
                <div className="grid md:grid-cols-4 gap-8 mb-8">
                    <div className="col-span-1 md:col-span-2">
                        <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-500 mb-4">
                            FreeTalk
                        </h3>
                        <p className="text-slate-600 dark:text-slate-400 max-w-sm">
                            A safe, anonymous space to share your thoughts, connect with others, and find support. No judgment, just conversation.
                        </p>
                    </div>
                    <div>
                        ...
                        <ul className="space-y-4 text-slate-600 dark:text-slate-400">
                            ...
                            <li><Link href="/chat" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Join Chat</Link></li>
                        </ul>
                    </div>
                    <div>
                ...
                <div className="border-t border-slate-200 dark:border-slate-900 pt-8 flex flex-col md:flex-row items-center justify-between text-slate-500 text-sm">
                    <p>&copy; {new Date().getFullYear()} FreeTalk. All rights reserved.</p>
